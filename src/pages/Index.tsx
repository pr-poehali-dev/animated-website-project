          ...
          <div className={`text-center transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <div className="mb-12">
              <img 
                ...
                className="w-72 h-72 lg:w-96 lg:h-96 mx-auto object-contain animate-[pulse_16s_cubic-bezier(0.4,0,0.6,1)_infinite] hover:scale-125 transition-transform duration-500"
              />
            </div>
